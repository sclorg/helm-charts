...
class TestHelmCakePHPMySQLTemplate:
    ...
    def setup_method(self):
        package_name = "cakephp-mysql-persistent"
    ...
    def test_curl_connection(self):
        ...
        self.hc_api.helm_package()
        assert self.hc_api.helm_installation()
        self.hc_api.package_name = "cakephp-mysql-persistent"
        ...
        assert self.hc_api.is_s2i_pod_running(pod_name_prefix="cakephp-mysql")
        assert self.hc_api.test_helm_curl_output(
            route_name="cakephp-mysql",
